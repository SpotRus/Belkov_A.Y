// d = √ (y1 - x1)² + (y2 - x2)² + (y3 - x3)²
// double result = Math.Sqrt(Math.Pow(pointB[x1], 2) + Math.Pow(y2 - x2, 2) + Math.Pow(y3 - x3, 2));
using System;
...
public class Answer
{
    private static double Length(int[] pointA, int[] pointB)
    {
        ...
        int x1 = pointA[0], x2 = pointA[1], x3 = pointA[2], y1 = pointB[0], y2 = pointB[1], y3 = pointB[2];
